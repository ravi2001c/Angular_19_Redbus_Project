...
export class SearchComponent implements OnInit {
  ...
  searchBus() {
    ...
    // this.http.get(
    //   "https://api.freeprojectapi.com/api/BusBooking/searchBus2?fromLocation="+this.searchObj.fromLocationId+"&toLocation="+this.searchObj.toLocationId+"&travelDate="+this.searchObj.date+"").subscribe((res:any)=>{
    //     debugger;
    //   });
  }
}
